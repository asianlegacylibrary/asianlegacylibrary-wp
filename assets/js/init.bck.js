            ...
            init: function() {
                ...
                function moving(active, curr) {
                    ...
                    if (curr.index() > active.index()) {
                        ...
                        //     }, 750)
                        // }
                        active.find('article').each(function() {
                            var curr = $(this);
                            curr.css(all.delaySetter(curr.data('delay-up')));
                        })
                        curr.find('article').each(function() {
                            var curr = $(this);
                    ...
                    //if (!all.mapViewed && !$('.nav-trigger').hasClass('close-btn')) {
                        ...
                        if (e.originalEvent.deltaY > 0) {
                            if (activeSection.index() < section.length - 1 && !running && !all.navOpened) {
                                ...
                                else if (activeSection.hasClass('with-auto-height') && activeSection.scrollTop() >= activeSection.find('.holder').outerHeight() - all.windowH && !atBottom) {}
                ...
                $(window).on('scrollFinished', function() {
                    ...
                    if (activeSection.hasClass('with-auto-height')) {
                        if (activeSection.scrollTop() <= 0) {
                            atBottom = false;
                            atTop = true;   
                        } else if (activeSection.scrollTop() >= activeSection.find('.holder').outerHeight() - all.windowH) {
                            atBottom = true;
                            atTop = false;
                        }
                    }
        ...
        desktop: {
            ...
            + Navigation's functionality */
                ...
                var subNavHovered = false,
                    ...
                    subnav = $('.sub-nav'),
                    mainNavLi = $('header .holder nav ul > li'),
                ...
                $('header .holder nav > ul > li > a').hover(function (e) {
                    var curr = $(this),
